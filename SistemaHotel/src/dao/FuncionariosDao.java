...
public class FuncionariosDao implements DaoGenerica<Funcionarios>{
    ...
    public String getTipoUser(String nome){
        String sql = "SELECT Tipo_User FROM Funcionario WHERE Usuario = ?";
        String tipoUserLogado = null;
        try{
            if(this.conexao.conectar()){
                PreparedStatement sentenca = this.conexao.getConnection().prepareStatement(sql);
                ...
                if(resultadoSentenca.next()){
                     tipoUserLogado = resultadoSentenca.getString("Tipo_User");
                }
            }
        }catch(SQLException ex)
        {
        ...
        try
        {
            if(this.conexao.conectar())
            {
                ...
                if(respuesta.next()){
                    ...
                    tela.setTipoUserLogado(getTipoUser(Usuario));
                   ...
                   /* TelaLogin telaLogin = new TelaLogin();
                    ...
                    JOptionPane.showMessageDialog(null, "Usuario Inexcistente, tente novamente.");
                }
                sentenca.close();
                this.conexao.getConnection().close();
            }
